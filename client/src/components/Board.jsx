...
const Board = () => {
  ...
  const currentBoard = boards.filter(board => board._id === id)[0];

  console.log('Inside Board component before useEffect; id is ', id);
  console.log('Inside Board component before useEffect; boards is ', boards);
  console.log('Inside Board component before useEffect; currentBoard is ', currentBoard);

  useEffect(() => {
    console.log('Inside Board component useEffect; id is ', id);
